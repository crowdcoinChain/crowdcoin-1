...
Download and install the Crowdcoin wallet from our [Official website](https://crowdcoin.site) or [Github](https://github.com/crowdcoinChain/Crowdcoin/releases)
...
***Step 3: Generate masternode genkey***
