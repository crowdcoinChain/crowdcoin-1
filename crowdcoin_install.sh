...
function important_information() {
 ...
 echo -e "When snyced, on your Windows wallet, create masternode.conf file"
 echo -e "Enter the following line :"
 echo -e "${GREEN}MASTERNODE CONFIG: ${NC}${PURPLE}$NODEIP:$COIN_PORT $COINKEY <TX> <ID>${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}crowdcoin-cli mnsync status${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
